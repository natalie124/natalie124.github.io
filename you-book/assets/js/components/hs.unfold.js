(function ($) {
    ...
    function AbstractUnfold(element, config) {
        ...
        this.smartPosition = function (target) {
            ...
            if (direction === "right") {
                if (!target.data("baseDirection")) target.data("baseDirection", { direction: "right", value: parseInt(styles.right, 10) });
                if (targetOuterGeometry.left < 0) {
                    target.css("right", (parseInt(target.css("right"), 10) - (targetOuterGeometry.left - 10)) * -1);
                }
            } else {
                if (!target.data("baseDirection")) target.data("baseDirection", { direction: "left", value: parseInt(styles.left, 10) });
